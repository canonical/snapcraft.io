...
from . import ratings_features_chart_pb2 as ratings__features__chart__pb2
...
if _version_not_supported:
    raise RuntimeError(
        ...
        + f' but the generated code in ratings_features_chart_pb2_grpc.py depends on'
...
def add_ChartServicer_to_server(servicer, server):
    ...
    server.add_registered_method_handlers('ratings.features.chart.Chart', rpc_method_handlers)
