      ...
      {!publisher ? (
        ...
        <>
          ...
          <Row>
            ...
            <Col size={6}>
              <p className="u-text-muted">
                This is a shorthand version of your name, used when space on
                screen is limited.
              </p>
            </Col>
          </Row>
          ...
          {publisher?.subscriptions && (
            <>
              ...
              <Row>
                ...
                <Col size={6}>
                  <p className="u-text-muted">
                    Get our latest and greatest blog posts delivered to your
                    inbox.
                  </p>
                  <hr />
                  <p className="u-text-muted">
              ...
              <div className="u-fixed-width">
                <Button
                  ...
                  onClick={async () => {
                    ...
                    data.set("newsletter", subscribeToNewsletter ? "on" : "");
