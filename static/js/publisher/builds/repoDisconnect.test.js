import { initRepoDisconnect } from "./repoDisconnect";

describe("repoDisconnect", () => {
  // let modal;
  // let form;
  // let buttons = [];
  // let input;
  ...
  //   buttons = [];
  // });
  it("should throw if the modal selector is invalid", () => {
    expect(initRepoDisconnect()).toThrow(".form is not a valid element");
  });
