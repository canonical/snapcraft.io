function enableInput(type) {
  const blackListMultiselect = document.querySelector('.js-blacklist .p-multiselect');
  const blackListMultiselectInput = blackListMultiselect.querySelector('.p-multiselect__input');
  const whiteListMultiselect = document.querySelector('.js-whitelist .p-multiselect');
  const whiteListMultiselectInput = whiteListMultiselect.querySelector('.p-multiselect__input');
