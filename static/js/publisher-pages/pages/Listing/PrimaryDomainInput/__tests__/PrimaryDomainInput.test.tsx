...
const mockUseFormReturnValue = {
  ...
  formState: {
    defaultValues: { primary_website: "https://example.com" },
  },
};

const renderComponent = (defaultValues: { [key: string]: any }) => {
  const Component = () => {
    const { register, getFieldState, getValues, formState } = useForm({
      defaultValues,
      mode: "onChange",
    });
